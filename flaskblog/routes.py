...
def update_post(post_id):
    ...
    return render_template('create_post.html', title='Update Poast',form=form,
                           legend='Update Post')
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'{form.username.data} Your password has been updated! You are now able to log in','success')
        return redirect(url_for('login'))
